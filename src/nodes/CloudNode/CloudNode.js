    ...
    >
      ...
      >
        ...
        <button onClick={increaseFontSizeTen} className={styles.tetxToolsBig}>
          ...
          />
          <FontAwesomeIcon icon={faPlus} className={styles.BigPlusIcon} />
        </button>

        <button onClick={increaseFontSize} className={styles.tetxTools}>
      ...
      >
        <div
          className={`${styles.copytop} ${styles.copy}`}
          style={{ display: data.isSelected ? "flex" : "none" }}
          onClick={() => {
            const newNode = {
              ...cloneNode,
        ...
        <div
          className={`${styles.copybottom} ${styles.copy}`}
          style={{ display: data.isSelected ? "flex" : "none" }}
          onClick={() => {
            const newNode = {
              ...cloneNode,
        ...
        <div
          className={`${styles.copyright} ${styles.copy}`}
          style={{ display: data.isSelected ? "flex" : "none" }}
          onClick={() => {
            const newNode = {
              ...cloneNode,
        ...
        <div
          className={`${styles.copyleft} ${styles.copy}`}
          style={{ display: data.isSelected ? "flex" : "none" }}
          onClick={() => {
            const newNode = {
              ...cloneNode,
